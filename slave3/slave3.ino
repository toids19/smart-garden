...
void setup() {
  ...
  Serial.println("WATER TANK 3 Transmitter Ready");
}

void loop() {
  delay(4000); //wait 4 seconds to offset from Tank 1
  ...
  if (fullness >= 0 && fullness <= 100) {
    String message = "WATER TANK 3: " + String(fullness) + "% full";
  ...
  delay(6000); //repeat every 6 seconds (aligned with Tank 1)
}
